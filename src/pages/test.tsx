...
import DrawerDemo from "@/components/Editor/PhotoEditor/UI/imagedrawer";
import Tags from "@/components/Editor/PhotoEditor/UI/tagInput";
import { FixedSizeList as List } from "react-window";
import { Chip, TextField } from "@mui/material";
import { Command } from "cmdk";
import React from "react";
import "../styles/framer.scss";
import { DragDropContext, DropResult, Draggable } from "react-beautiful-dnd";
interface TextWithLinksProps {
  text: string;
}

import { StrictModeDroppable as Droppable } from "@/components/Editor/PhotoEditor/UI/strictmodedroppable";
import Script from "next/script";
import DynamicPlot from "@/components/Editor/PhotoEditor/UI/dynamicplot";
export const TextWithLinks: React.FC<TextWithLinksProps> = ({ text }) => {
  // Function to convert [[link|display]] to <a> tag
  const convertLinks = (str: string) => {
    return str.replace(/\[\[(.*?)\]\]/g, (_, match) => {
      const [link, display] = match.split("|");
      return `<a href="/wiki/${link}" class="text-blue-500 hover:underline">${
        display || link
      }</a>`;
    });
  };
  ...
  const formattedText = text
    ...
    .map((paragraph, index) => (
      <p
        key={index}
        dangerouslySetInnerHTML={{ __html: convertLinks(paragraph) }}
      />
    ));
...
const SheetDemo = () => {
  ...
  const sigmoid2 = (x: number) => 1 / (1 + Math.exp(-x));
            ...
            <div cmdk-framer-right="">
              {value === "breasts" && (
                <div>
                  <TextWithLinks
                    text={
                      'A [[pirate]] adventure manga and anime series drawn by [[Oda Eiichirou]] in 1997 and the best-selling manga in Japan of all time. An animated adaptation was produced by [[Toei Animation]] and a [[one piece (live action)|live action adaptation]] was later produced by [[Netflix]].\r\n\r\nSet in a vast ocean world governed by the elusive World Government. The series follows [[Monkey D. Luffy]] and the crew of the Straw Hat Pirates in search for the titular "One Piece", a treasure said to contain a world-changing power.\r\n\r\nThe series has a spinoff called [[Shokugeki no Sanji]], itself an off-shoot of [[Shokugeki no Souma]].\r\n\r\n[b][[Straw Hat Pirates|Strawhat Pirates:]][/b]\r\nThe main characters of the series:\r\n* [[Monkey D. Luffy|]]\r\n* [[Roronoa Zoro]]\r\n* [[Nami (one piece)|]]\r\n* [[Usopp]]\r\n* [[Sanji (one piece)|]]\r\n* [[Tony Tony Chopper]]\r\n* [[Nico Robin]]\r\n* [[Franky (one piece)|]]\r\n* [[Brook (one piece)|]]\r\n* [[Jinbe (one piece)|]]\r\n\r\n[b]Female characters:[/b]\r\n* [[Alvida (one piece)|]]\r\n* [[Boa Hancock]]\r\n* [[Baby 5]]\r\n* [[Camie (one piece)|]]\r\n* [[Carrot (One Piece)|]]\r\n* [[Charlotte Linlin]]\r\n* [[Conis (one piece)|]]\r\n* [[Kalifa (one piece)|]]\r\n* [[Kaya (One Piece)|]]\r\n* [[Marguerite (one piece)|]]\r\n* [[Jewelry Bonney]]\r\n* [[Nefertari Vivi]]\r\n* [[Perona]]\r\n* [[Monet (One Piece)|]]\r\n* [[Shirahoshi]]\r\n* [[Nojiko]]\r\n* [[Rebecca (One Piece)|]]\r\n* [[Tashigi]]\r\n* [[Yamato (One Piece)|]]\r\n\r\n [b]Male characters:[/b]\r\n* [[Buggy the Clown]]\r\n* [[Dracule Mihawk]]\r\n* [[Dr. Vegapunk]]\r\n* [[Marco (one piece)|]]\r\n* [[Silvers Rayleigh]]\r\n* [[Bartholomew Kuma]]\r\n* [[Edward Newgate]]\r\n* [[Marshall D. Teach]]\r\n* [[Shanks (one piece)|]]\r\n* [[Smoker (one piece)|]]\r\n* [[Portgas D. Ace]]\r\n* [[Donquixote Doflamingo]]\r\n* [[crocodile (one piece)|Sir Crocodile]]\r\n* [[kaidou_(one_piece)|Kaidou]]\r\n* [[Rob Lucci]]\r\n* [[Trafalgar Law]]\r\n\r\n[b]Organizations & Groups:[/b]\r\n* [[Baroque Works]]\r\n* [[CP9]]\r\n* [[Eleven Supernova]]\r\n* [[Shichibukai]]\r\n* [[Whitebeard Pirates]]\r\n\r\n[b]Objects:[/b]\r\n* [[Devil Fruit]]\r\n* [[Den Den Mushi]]\r\n* [[Log Pose]]\r\n\r\nFor a full list of Characters, see.\r\n[[List of One Piece Characters]]\r\n\r\n[b]Movie-related tags:[/b]\r\n* [[one piece: The Movie|The Movie]]\r\n* [[one piece: clockwork island adventure|Clockwork Island Adventure]]\r\n* [[one piece: dead end adventure|Dead End Adventure]]\r\n* [[one piece: the cursed holy sword|The Cursed Holy Sword]]\r\n* [[one_piece:_baron_omatsuri_and_the_secret_island|Baron Omatsuri and the Secret Island]]\r\n* [[one piece: the giant mechanical soldier of karakuri castle|The Giant Mechanical Soldier of Karakuri Castle]]\r\n* [[one piece: strong world|Strong World]]\r\n* [[one piece film: z|Movie Z]]\r\n* [[one piece film: gold|Film Gold]]\r\n* [[one piece: stampede|Stampede]]\r\n* [[one piece film: red|Film Red]]\r\n\r\nOfficial Twitter: https://twitter.com/OPcom_info/'
                    }
                  />
                </div>
              )}
