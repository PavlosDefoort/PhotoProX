...
import { Folder, HexagonIcon } from "lucide-react";
import { Application, Container } from "pixi.js";
import AdjustmentLayerBarItem from "./adjustmentLayerBarItem";
import BackgroundLayerBarItem from "./backgroundLayerBatItem";
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        ...
                        <DropdownMenuItem
                          onClick={() => {
                            alert(
                              "This button is currently in development! To add a new image layer, you can also go to File -> Open or Ctrl+O."
                            );
                          }}
                        >
                          {" "}
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            alert("Groups are currently in development!")
                          }
                        >
                          {" "}
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <TrashIcon
                        ...
                        onClick={() => {
                          if (project.target?.type === "background") {
                            return;
                          }
                          if (
                            ...
                            setProject((draft) => {
                              if (draft.target) {
                                draft.layerManager.removeLayer(draft.target.id);
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            setProject((draft) => {
                              // Move the target layer to the front
                              if (draft.target) {
                                draft.layerManager.moveLayerUp(draft.target.id);
                                draft.layerManager.checkZIndex();
                                draft.target = draft.layerManager.findLayer(
                                  draft.target.id
                                ) as Draft<ImageLayer>;
